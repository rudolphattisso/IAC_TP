<?php
    ...
    if (isset($_GET['id'])) {
        ...
        if ($res === false) {
            ...
            // PostgreSQL retourne les noms de colonnes en minuscules — remapping pour le formulaire
            $produit = [
                'PRO_id'          => $produit['pro_id'],
                'PRO_lib'         => $produit['pro_lib'],
...
<body>
    <div class="container">
        ...
        <form action="validation.php" method="post" enctype="multipart/form-data">
            ...
            ?>
            <input type="hidden" id="PRO_id" name="PRO_id" value="<?php echo $produit['PRO_id'] ?>" >
            <?php
                }
            ?>
